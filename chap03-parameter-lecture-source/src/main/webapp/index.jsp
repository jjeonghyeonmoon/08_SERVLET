...
<form action="querystring" method="get">
    ...
    <label for="movie">코딩</label>
    <br>
    <input type="submit" value="GET 요청">
</form>
<h4>a 태그의 href 속성에 직접 데이터 넣어서 get 요청</h4>
<a href="querystring?name=김경훈&age=29&birthday=1995-06-03&gender=M&national=ko&hobbies=movie&hobbies=music">
    쿼리스트링을 이용한 값 전달
</a>
...
<form action="formdata" method="post">
    ...
    <br>
    <label>취미 : </label>
    <input type="checkbox" name="hobbies" id="movie1" value="movie">
    <label for="movie">영화</label>
    <input type="checkbox" name="hobbies" id="music1" value="music">
    <label for="movie">음악</label>
    <input type="checkbox" name="hobbies" id="coding1" value="coding">
    <label for="movie">코딩</label>
    <br>
    <input type="submit" value="GET 요청">
</form>
